// src/ui/mod.rs
//
// Main UI module. Composes the foobar2000-style layout:
//   ┌──────────────────────────────────────────────┐
//   │  Track info + Visualiser                      │
//   ├──────────────────────────────────────────────┤
//   │  ▓▓▓▓▓▓▓▓▓▓▓▓▓░░░░░░░░░░  2:34 / 5:10      │  ← progress bar
//   ├──────────────────────────────────────────────┤
//   │  ◄◄  ▶/❚❚  ■  ►►  │  🔀  🔁  │  + Files ... │
//   ├──────────────────────────────────────────────┤
//   │  🔍 [search________________]  42 / 300 tracks│
//   ├──────────────────────────────────────────────┤
//   │  # │ Title       │ Author   │ Time │ SIDs    │
//   │  1 │ Commando    │ R.Hubbard│ 3:42 │ 1       │
//   │  …                                           │
//   └──────────────────────────────────────────────┘
