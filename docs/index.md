...
- `H` hearts the current track. `F` toggles full-screen visualiser. `V` cycles Bars / Scope / Tracker / Karaoke.
- `Ctrl+F` focuses the search box. Sortable columns — click any header (Title / Author / Duration / Type / SIDs).
